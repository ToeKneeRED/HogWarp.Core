using HogWarp.Common.Async.Promises;
using System;
using System.Collections.Generic;
using System.Linq;
using HogWarp.Common.Async.Exceptions;

namespace HogWarp.Common.Async
{
    /// <summary>
...
//            Argument.NotNull(() => ex);
        ...
        {
            if (resolveCallbacks != null && resolveRejectables != null)
            {
